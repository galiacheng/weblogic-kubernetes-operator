...
| `monitoringExporter` | [Monitoring Exporter Specification](#monitoring-exporter-specification) |  |
...
| `image` | string | The WebLogic Monitoring Exporter sidecar image name. Defaults to oracle/weblogic-monitoring-exporter:2.0 |
